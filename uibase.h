...
class CMainFrameBase : public wxFrame
{
	...
	protected:
		...
		virtual void OnToolAboutClicked( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnToolCheckBox( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnToolSettings( wxCommandEvent& event ) { event.Skip(); }
